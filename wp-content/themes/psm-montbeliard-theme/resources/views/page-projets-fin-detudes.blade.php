...
@section('content')
    <section id="projects-page-header" class="page-header">
        <div class="row header" style="background-image: url('{!! get_theme_mod('projets_pfe_page_header_section_img',\App\App::get_image_page_header('projets_pfe', 'jpg')) !!}')">
            <div class="filter"></div>
            <div class="header-content">
                <div class="d-flex justify-content-center" style="width: 100%;">
                    <span class="projets_pfe_page_header_section_img" style="width: 1px"></span>
                </div>
                <h1 class="projets_pfe_page_header_section_title">
                    {{ get_theme_mod(
                        'projets_pfe_page_header_section_title',
                        get_the_title()
                    ) }}
                </h1>
                <p class="formation projets_pfe_page_header_section_subtitle">
                    {{ get_theme_mod(
                        'projets_pfe_page_header_section_subtitle',
                        'Master 2 PSM'
                    ) }}
                </p>
            </div>
    ...
    <section id="projects-page-presentation-section" class="section-image-left-content-right">
        <div class="row justify-content-center align-items-center">
            <div class="content offset-0 offset-md-2 col-12 col-md-9">
                <div class="row">
                    <div class="picture col-12 col-md-3 no-padding">
                        {!! get_template_part('/assets/images/svg/inline', 'anpfe.svg') !!}
                    </div>
                    <div class="text col-12 col-md-9 d-flex justify-content-center align-items-start flex-column">
                        <h2 class="projets_pfe_page_presentation_section_title">
                            {{ get_theme_mod(
                                'projets_pfe_page_presentation_section_title',
                                'Lorem ipsum dolores'
                            ) }}
                        </h2>
                        <div class="projets_pfe_page_presentation_section_text">
                            {!! get_theme_mod(
                                'projets_pfe_page_presentation_section_text',
                        ...
                        <div class="btns-box">
                            <span class="projets_pfe_page_presentation_section_link_page_master_1">
                                 <a class="btn btn-psm-green" href="{!! site_url() .'/?p='. get_theme_mod(
                                    'projets_pfe_page_presentation_section_link_page_master_1',
                                    '4&formation=m2'
                                ) !!}">Master 2</a>
                            </span>
                        </div>
            ...
            <div id="projects-navigation" class="col-12">
                ...
                <div class="d-flex justify-content-center" style="width: 100%;">
                    <span class="projets_pfe_page_projects_section_years_dropdown_list" style="width: 1px"></span>
                </div>
                <select>
                    {{--@php($option_number =  get_theme_mod('projets_pfe_page_projects_section_years_dropdown_list','6'))
