...
jQuery(document).ready(function( $ ) {
    ...
    fusee_tl.set(div_anac2, {border:'solid 2px #e8e8e8'})
        ...
        .add(new TimelineMax({repeat:-1, repeatDelay:3}).to(fusee, 0.2, {rotation:-1, yoyo:true, repeat:1, ease:Power0.easeNone}).to(fusee, 0.2, {rotation:1, yoyo:true, repeat:1, ease:Power0.easeNone}).to(fusee, 0.2, {rotation:1, yoyo:true, repeat:1, ease:Power0.easeNone}, 3).to(fusee, 0.2, {rotation:-1, yoyo:true, repeat:1, ease:Power0.easeNone}))
    fusee_tl.timeScale(1.5);


    var controllerProjectsSection = new ScrollMagic.Controller();
    new ScrollMagic.Scene({
        triggerElement: "#projects-picture",
        triggerHook: "onEnter"
    })
    ...
    var anac3_1 = $('#1-anac3'),
        ...
        barres_anac3 = $('#barres_anac3'),
        pro_anac3 = $('#pro-anac3'),
        lum_anac3 = $('#lum-anac3 circle')
        ;

    var anac3_tl = new TimelineMax({repeat:-1}),
        tl_jeff = new TimelineMax(),
        tl_fede = new TimelineMax(),
        tl_al = new TimelineMax();
    ...
    anac3_tl.to(pro_anac3, 0.1, {opacity:0})
        ...
        .to(balle_jeff, 3, {bezier:{type:'soft', values:[{x:-140, y:-380, scale:0.4, transformOrigin:"50% 50%"}, {x:-400, y:-1300, scale:0.3, transformOrigin:"50% 50%"}, {x:-500, y:-450, scale:0, transformOrigin:"50% 50%"}]}, ease:Circ.easeOut}, 5.1)
        ...
        .fromTo(bague_dev_anac3, 0.5, {scale:0, transformOrigin:"50% 50%"}, {scale:1.5, opacity:0, transformOrigin:"50% 50%"}, 6.5)
        ...
        .to(balle_fede, 3, {bezier:{type:'soft', values:[{x:140, y:-380, scale:0.4, transformOrigin:"50% 50%"}, {x:400, y:-1300, scale:0.3, transformOrigin:"50% 50%"}, {x:500, y:-450, scale:0, transformOrigin:"50% 50%"}]}, ease:Circ.easeOut}, 15.1)
        ...
        .fromTo(bague_com_anac3, 0.5, {scale:0, transformOrigin:"50% 50%"}, {scale:1.5, opacity:0, transformOrigin:"50% 50%"}, 16.5)
        ...
        .to(balle_al, 3, {bezier:{type:'soft', values:[{y:-380, scale:0.4, transformOrigin:"50% 50%"}, {y:-1300, scale:0.3, transformOrigin:"50% 50%"}, {y:-450, scale:0, transformOrigin:"50% 50%"}]}, ease:Circ.easeOut}, 25.1)
        ...
        .fromTo(bague_gestion_anac3, 0.5, {scale:0, transformOrigin:"50% 50%"}, {scale:1.5, opacity:0, transformOrigin:"50% 50%"}, 26.5)
    ...
    var controllerProfessionalSection = new ScrollMagic.Controller();
    new ScrollMagic.Scene({
        triggerElement: "#professional-picture",
        triggerHook: "onEnter"
    })
        .addIndicators({name: "Professional", indent: 800}) // add indicators (requires plugin)
        .addTo(controllerProfessionalSection)
        .setTween(anac3_tl);
},jQuery);
